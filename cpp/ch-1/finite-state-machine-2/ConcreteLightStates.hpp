...
public:
    void enter(Light* light) {
        std::cout << "Entering LightOff" << std::endl;
    }
    void toggle(Light* light);
    void exit(Light* light) {
        std::cout << "Exiting LightOff" << std::endl;
    }
...
public:
    void enter(Light* light) {
        std::cout << "Entering LowIntensity" << std::endl;
    }
    void toggle(Light* light);
    void exit(Light* light) {
        std::cout << "Exiting LowIntensity" << std::endl;
    }
    static LightState& getInstance();
...
public:
    void enter(Light* light) {
        std::cout << "Entering MediumIntensity" << std::endl;
    }
    void toggle(Light* light);
    void exit(Light* light) {
        std::cout << "Exiting MediumIntensity" << std::endl;
    }
    static LightState& getInstance();
...
public:
    void enter(Light* light) {
        std::cout << "Entering HighIntensity" << std::endl;
    }
    void toggle(Light* light);
    void exit(Light* light) {
        std::cout << "Exiting HighIntensity" << std::endl;
    }
    static LightState& getInstance();
